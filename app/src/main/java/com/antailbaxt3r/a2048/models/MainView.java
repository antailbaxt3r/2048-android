package com.antailbaxt3r.a2048.models;
...
import com.antailbaxt3r.a2048.R;
import com.antailbaxt3r.a2048.listener.InputListener;
...
public class MainView extends View {
    ...
    public boolean hasSaveState = false, continueButtonEnabled = false;
    public int startingX, startingY, endingX, endingY;
    //Icon variables
    public int sYIcons, sXNewGame, sXUndoiconSize, iconSize, sXUndo;
    //Misc
    public boolean refreshLastTime = true, showHelp;
    //Timing
    private long lastFPSTime = System.nanoTime();
    //Text
    private float titleTextSize, bodyTextSize, headerTextSize, instructionsTextSize, gameOverTextSize;
    //Layout variables
    private float textSize = 0, cellTextSize = 0;
    private int gridWidth = 0, cellSize = 0, textPaddingSize, iconPaddingSize;
    //Assets
    private Drawable backgroundRectangle, lightUpRectangle, fadeRectangle;
    private Bitmap background = null;
    private BitmapDrawable loseGameOverlay, winGameContinueOverlay, winGameFinalOverlay;
    //Text variables
    private int sYAll, titleStartYAll, bodyStartYAll, eYAll, titleWidthHighScore, titleWidthScore;
